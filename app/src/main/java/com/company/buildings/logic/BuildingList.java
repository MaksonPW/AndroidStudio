...
public class BuildingList {
    ...
    public BuildingList() {
        ...
        mHouse[2] = new House(20, 40, 56, 60, "James Madison", true);
        mHouse[3] = new House(100, 100, 110, 110, "John Quincy Adams", true);
        mHouse[4] = new House(10, 10, 100, 100, "Andrew Jackson", true);
        mHouse[5] = new House(10, 10, 12, 12);
        mHouse[6] = new House(10, 10, 12, 12);
        mHouse[6].setPool(true);
